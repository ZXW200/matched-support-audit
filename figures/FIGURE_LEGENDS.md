...
Source data: `fig3_similarity_filter.csv`, `fig3_pd_roi_summary.csv`, `fig3_pd_translated_supports.csv`, `fig3_random_pixel_budgets.csv`, `fig3_distributed_controls.csv`, `fig3_detector_conditions.csv` and `fig3_detector_shuffle.csv`.
